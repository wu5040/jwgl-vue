<template>
  <div style="width:100%">
    <div class="course">
      ...
      <el-table :data="CourseData" v-loading="loading" style="margin: 0 auto; width: 100%; text-align:center;" fit=true :stripe="true" :border="false">
...
export default {
  ...
  created: function() {
    this.loading = true;
    this.axios
      .get("http://localhost:8099/admin/student", {
